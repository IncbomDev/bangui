package me.kodysimpson.bangui.utils;
...
public class BanMenuUtils {
    ...
    public static void openPlayerMenu(Player player1, Player whoToBan){
        ...
        //Open up ban menu
        Inventory banPlayerMenu = Bukkit.createInventory(player1, 9, "Ban a Player");

        //Ban Option
        ItemStack ban = new ItemStack(Material.WOODEN_AXE, 1);
        ItemMeta ban_meta = ban.getItemMeta();
        ban_meta.setDisplayName(ChatColor.DARK_GREEN + "Ban" + whoToBan);
        ...
        cancel_meta.setDisplayName(ChatColor.RED + "Back to Main Menu");
